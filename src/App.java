public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println();
        System.out.println();
        System.out.printf("%-30s%-30s%-30s%30s%n", "Factura A", "ENVIAR A", "Nº DE FACTURA","ES-001");
        System.out.printf("%-30s%-30s%-30s%30s%n", "Leda Villa real", "Leda Villareal", "FECHA","29.01.2019");
        ...
        System.out.printf("%-30s%-30s%-30s%30s%n", "", "", "FECHA", "29-01-2019");
